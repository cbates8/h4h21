...
class User(db.Model):
    ...
    usr_name = db.Column("username", db.String(100), nullable=True)
...
class Business(db.Model):
    ...
    busn_name = db.Column("name", db.String(255), primary_key=True)
    busn_pwd = db.Column("password", db.String(100), nullable=True)
